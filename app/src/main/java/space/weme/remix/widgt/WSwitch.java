...
public class WSwitch extends ViewGroup {
    ...
    public WSwitch(Context context, AttributeSet attrs) {
        ...
        colorOn = a.getColor(R.styleable.WSwitch_colorOn, context.getResources().getColor(R.color.colorPrimary));
        colorOff = a.getColor(R.styleable.WSwitch_colorOff,Color.WHITE);
        a.recycle();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //Measure Width
        int desiredWidth = DimensionUtils.getDisplay().widthPixels/3;
